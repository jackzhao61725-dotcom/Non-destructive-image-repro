...
from dissertation_figure_style import BLUE, INK, LIGHT_GREY, ORANGE, dissertation_style
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        default="configs/public_chapter_5_snr_recovery_relation_v1.json",
    )
    ...
    summary = {
        "schema_version": 1,
        "label": config["label"],
        "status": config.get("status", "scratch_preview_not_retained"),
